...
public final class Transformers {
    ...
    public static <I, O> List<O> transform(final Iterable<I> base, final Function<I, O> transformer) {
        final List<O> outputData = new ArrayList<>();

        for (final I input : base) {
            outputData.add(transformer.call(input));
        }
    ...
    public static <I> List<? extends I> flatten(final Iterable<? extends Collection<? extends I>> base) {
        final List<I> outputData = new ArrayList<>();

        for (final Collection<? extends I> rootItem : base) {
            for (final I nestedItem : rootItem) {
                outputData.add(nestedItem);
            }
        }
    ...
    public static <I> List<I> select(final Iterable<I> base, final Function<I, Boolean> test) {
        final List<I> filteredData = new ArrayList<>();

        for (final I item : base) {
            if (test.call(item)) {
